...
<body>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Những mặt hàng phổ biến</h1>
                </div>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Bữa ăn sáng</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Bữa ăn nhẹ</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3">
                                ...
                                <div class="ps-3">
                                    <small class="text-body">Thân Mật</small>
                                    <h6 class="mt-n1 mb-0">Bữa ăn tối</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>{{$sp -> name}}</span>
                                                <span class="text-primary">{{ number_format($sp->price, 0, ',', '.') }} VNĐ</span>
                                            </h5>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const userSection = document.querySelector('.header__top__right__user');
